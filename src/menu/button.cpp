...
Button::Button(MenuState* menuState, const NovaColor& buttonColor, std::string label, const NovaColor& labelColor,
	...
	borders[0].lineColors[BEGIN] = &borderData.lineColors[0];
	...
	borders[0].lineColors[END] = &borderData.lineColors[1];
	...
	borders[1].lineColors[BEGIN] = &borderData.lineColors[1];
	...
	borders[1].lineColors[END] = &borderData.lineColors[0];
	...
	borders[2].lineColors[BEGIN] = &borderData.lineColors[0];
	...
	borders[2].lineColors[END] = &borderData.lineColors[1];
	...
	borders[3].lineColors[BEGIN] = &borderData.lineColors[1];
	...
	borders[3].lineColors[END] = &borderData.lineColors[0];
...
void Button::draw() {
	...
	if (this->isSelected()) {
		...
		for (int i = 0; i < NUMBER_OF_BORDERS; i++) {
			...
			glColor3fv(line->lineColors[BEGIN]->data);
			glVertex2i(line->displayVertices[BEGIN]->x, line->displayVertices[BEGIN]->y);

			glColor3fv(line->lineColors[END]->data);
