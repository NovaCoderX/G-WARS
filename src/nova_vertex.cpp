...
/*
 ** AstFixedpoint_t NovaVertex::Dot ( const NovaVertex & ) const
 **
...
/*
 ** void NovaVertex::operator *= ( AstFixedpoint_t scaler )
 **
...
/*
 ** NovaVertex operator * ( const NovaVertex &v, AstAstMatrix3x3 &m )
 ** void NovaVertex::operator *= ( AstAstMatrix3x3 &m )
 **
...
/*
 ** NovaVertex operator * ( const NovaVertex &v, AstAstMatrix4x3 &m )
 **
